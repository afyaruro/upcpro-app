...
Widget DropdownBtnFaculty({
  required String hintText,
  required List<FacultyEntity> items,
  required FacultyEntity selectedItem,
  required Function(FacultyEntity?) onChanged,
      ...
      children: [
        ...
        Expanded(
          child: DropdownButtonHideUnderline(
            child: DropdownButton<FacultyEntity>(
