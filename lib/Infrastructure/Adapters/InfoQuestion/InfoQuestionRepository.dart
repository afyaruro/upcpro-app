...
class InfoQuestionRepository implements IInfoQuestionRepository {
  ...
  @override
  Future<bool> saveInfoQuestionsHive(List<InfoQuestionModel> infoQuestions, Box box) async {
    return await SaveInfoQuestionDataSourceHive().saveInfoQuestion(infoQuestions, box);
  }
}
